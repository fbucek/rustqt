...
namespace {
    ...
    inline void databaseMessageChanged(Database* o)
    {
...
extern "C" {
    Database::Private* database_new(Database*, void (*)(Database*), void (*)(Database*));
    void database_free(Database::Private*);
    void database_message_get(const Database::Private*, QString*, qstring_set);
...
QString Database::message() const
{
    QString v;
    database_message_get(m_d, &v, set_qstring);
    return v;
}
